...
export const sessions: HermesSession[] = [
  {
    id: "session-001",
    title: "Cogito frontend integration",
    profile: "default",
    created: "2026-06-22T09:00:00Z",
    lastModified: "2026-06-22T14:32:00Z",
    messageCount: 42,
    preview: "Setting up session list and detail pages for the Agentic OS. Integrated with Hermes backend.",
  },
  {
    id: "session-002",
    title: "Hermes database query design",
    profile: "default",
    created: "2026-06-22T08:15:00Z",
    lastModified: "2026-06-22T12:45:00Z",
    messageCount: 28,
    preview: "Designing the query interface to pull sessions from the local Hermes database.",
  },
  {
    id: "session-003",
    title: "Dark theme refinement",
    profile: "default",
    created: "2026-06-21T16:30:00Z",
    lastModified: "2026-06-21T18:10:00Z",
    messageCount: 15,
    preview: "Adjusting the zinc color palette and border transparency for better visual hierarchy.",
  },
  {
    id: "session-004",
    ...
    lastModified: "2026-06-20T15:20:00Z",
    messageCount: 35,
    preview: "Planning the REST API structure for sessions, approvals, and workflows.",
  },
  {
    id: "session-005",
    title: "Component reusability audit",
    profile: "default",
    created: "2026-06-19T13:45:00Z",
    lastModified: "2026-06-19T16:55:00Z",
    messageCount: 22,
    preview: "Reviewing Card, Badge, and Button components for consistent styling across pages.",
  },
];
